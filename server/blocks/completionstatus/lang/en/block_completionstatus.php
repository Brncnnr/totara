...
$string['completeallactivities'] = 'Complete all course activities: {$a->first} of {$a->second}';
$string['completeanyactivities'] = 'Complete any course activities: {$a->first} of {$a->second}';
...
$string['conditionmet'] = 'Condition met?';
