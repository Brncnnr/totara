...
$string['image_size_x'] = 'Image size: {$a}';
...
$string['layout_narrow_left_column'] = 'Narrow left column';
$string['layout_narrow_right_column'] = 'Narrow right column';
$string['layout_one_column'] = 'One column';
$string['layout_settings'] = 'Layout settings';
$string['layout_three_column'] = 'Three column';
$string['layout_two_column'] = 'Two column';
$string['layout_x'] = 'Layout: {$a}';
$string['link'] = 'Link';
