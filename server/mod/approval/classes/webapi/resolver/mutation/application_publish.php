...
final class application_publish extends mutation_resolver {
    ...
    public static function resolve(array $args, execution_context $ec): array {
        ...
        // Can only publish when in approvals.
        if (!$application->get_current_state()->is_stage_type(approvals::get_code())) {
            throw new model_exception("Can't publish because not in-approvals");
        }
        ...
        builder::get_db()->transaction(function () use ($application, $user, $form_data, $keep_approvals) {
