 ...
 */
class mod_approval_totara_notification_level_approved_testcase extends mod_approval_totara_notification_level_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $level_approved_event = level_approved_event::create_from_application($data->application1, null);
        $level_approved_event->trigger();
    ...
    public function test_get_scheduled_events(): void {
        ...
        $resolver_class_name = level_approved_resolver::class;
