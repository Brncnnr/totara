 ...
 */
class mod_approval_totara_notification_level_rejected_testcase extends mod_approval_totara_notification_level_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $level_rejected_event = level_rejected_event::create_from_application($data->application1);
        $level_rejected_event->trigger();
