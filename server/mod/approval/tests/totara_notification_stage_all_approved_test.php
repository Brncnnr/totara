 ...
 */
class mod_approval_totara_notification_stage_all_approved_testcase extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $stage_all_approved_event = stage_all_approved_event::create_from_application($data->application1);
        $stage_all_approved_event->trigger();
