 ...
 */
class mod_approval_totara_notification_stage_ended_testcase extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $stage_ended_event = stage_ended_event::create_from_application($data->application1);
        $stage_ended_event->trigger();
