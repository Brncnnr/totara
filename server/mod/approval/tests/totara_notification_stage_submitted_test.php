 ...
 */
class mod_approval_totara_notification_stage_submitted_testcase extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $stage_submitted_event = stage_submitted_event::create_from_application($data->application1);
        $stage_submitted_event->trigger();
