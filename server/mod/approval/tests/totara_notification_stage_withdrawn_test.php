 ...
 */
class mod_approval_totara_notification_stage_withdrawn_testcase extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $stage_withdrawn_event = stage_withdrawn_event::create_from_application($data->application1);
        $stage_withdrawn_event->trigger();
