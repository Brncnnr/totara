...
$string['achievement_paths_need_review_completely'] = 'The achievement paths were successfully applied to {$a->count} competencies. All of them contain a criteria-based path that needs to be reviewed. These changes might take a while to be reflected throughout the site.';
